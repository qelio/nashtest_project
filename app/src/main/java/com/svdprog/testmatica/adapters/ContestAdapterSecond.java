...
// // Getting a list of available tests in any thematic area for two option...

public class ContestAdapterSecond extends ArrayAdapter<Contest> {
    private LayoutInflater inflater;
    private int layout;
    private ArrayList<Contest> contestList;
    public Intent intent;
    public Context context;
    public ContestAdapterSecond(Context context, int resource, ArrayList<Contest> contests, Intent intent) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Starting the flow getting exercises for the selected variant of thematic test:
        viewHolder.button_first.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        // Starting the flow getting exercises for the selected variant of thematic test:
        viewHolder.button_second.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String temp = "https://testmatica.ru/api/get_exercise.php?authorization_key=t2EyVwlZsLwP7TeAlyrJ&start=" + contest.getStart2() + "&finish=" + contest.getFinish2();
                new GetExercise(contest, context, intent).execute(temp);
            }
        });
        return convertView;
    ...
    private class ViewHolder {
        final Button button_first;
        final Button button_second;
